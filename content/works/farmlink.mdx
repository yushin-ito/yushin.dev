...
published: true
thumbnail: /images/farmlink/thumbnail.png
deck:
  directory: /images/farmlink/deck
  length: 19
...
<div className="mx-auto box-content aspect-[9/19.5] w-[210px] overflow-hidden rounded-[32px] border-8 border-zinc-800 shadow">
  <video autoPlay muted loop playsInline width="100%" height="100%">
    <source src="/videos/farmlink/rental.mp4" type="video/mp4" />
  </video>
</div>
...
<div className="mx-auto box-content aspect-[9/19.5] w-[210px] overflow-hidden rounded-[32px] border-8 border-zinc-800 shadow">
  <video autoPlay muted loop playsInline width="100%" height="100%">
    <source src="/videos/farmlink/community.mp4" type="video/mp4" />
  </video>
</div>
...
<div className="mx-auto box-content aspect-[9/19.5] w-[210px] overflow-hidden rounded-[32px] border-8 border-zinc-800 shadow">
  <video autoPlay muted loop playsInline width="100%" height="100%">
    <source src="/videos/farmlink/record.mp4" type="video/mp4" />
  </video>
</div>
