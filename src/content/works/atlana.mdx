...
<div className="mx-auto aspect-square w-[300px]">
  <video autoPlay muted loop playsInline width="100%" height="100%">
    <source src="/videos/works/atlana/demo.mp4" type="video/mp4" />
  </video>
</div>
...
<Image
  src="/images/works/atlana/annotation.png"
  alt="annotation"
  width={300}
  height={300}
  className="mx-auto"
...
<Image
  src="/images/works/atlana/segmentation.png"
  alt="segmentation"
  width={300}
  height={300}
  className="mx-auto"
...
<div className="grid gap-10 px-2 sm:grid-cols-2">
  <div className="w-full aspect-8/5 relative">
    <Image
      src="/images/works/atlana/area.png"
      alt="area"
      width={800}
      height={500}
    />
  ...
  <div className="w-full aspect-8/5 relative">
    <Image
      src="/images/works/atlana/volume.png"
      alt="volume"
      width={800}
      height={500}
    />
...
- **フロー画面** <br/>
  ...
  <Mockup alt="atlana.com" src="/images/works/atlana/flow.png" width={1920} height={1250} />
...
- **分析画面** <br/>
  ...
  <Mockup alt="atlana.com" src="/images/works/atlana/analytics.png" width={1920} height={1250} />
...
- **ログ画面** <br/>
  ...
  <Mockup alt="atlana.com" src="/images/works/atlana/log.png" width={1920} height={1250} />
...
- **コントロール画面** <br/>
  ...
  <Mockup alt="atlana.com" src="/images/works/atlana/control.png" width={1920} height={1250} />
...
<div className="grid grid-cols-3 gap-16 px-6 md:grid-cols-6 md:px-4">
  <div className="flex flex-col items-center space-y-2">
    <Icons.python className="size-16 dark:fill-white" />
